package com.chan.chandummy.java;
...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    private void ensureScrollAnimator() {
        if (mScrollAnimator == null) {
            ...
            mScrollAnimator.setInterpolator(CustomAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setInterpolator(CustomAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animator) {
                        ...
                        setIndicatorPosition(
                                CustomAnimationUtils.lerp(startLeft, targetLeft, fraction),
                                CustomAnimationUtils.lerp(startRight, targetRight, fraction));
                    }
                });
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft + 100, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight - 100, getHeight(), mSelectedIndicatorPaint);
            }
        }
    }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final CustomTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
